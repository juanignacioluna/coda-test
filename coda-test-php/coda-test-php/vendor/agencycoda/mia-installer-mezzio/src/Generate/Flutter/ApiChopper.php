 ...
 */
class ApiChopper extends \Mia\Installer\BaseFile
{
    /**
     * Path del archivo a tener de base
     * @var string
     */
    protected $filePath = './vendor/agencycoda/mia-installer-mezzio/data/flutter/api_chopper.txt';
    /**
    ...
    public function run()
    {
        ...
        file_put_contents($this->savePath . $this->name . '.api.chopper.dart', $this->file);
    }
}
