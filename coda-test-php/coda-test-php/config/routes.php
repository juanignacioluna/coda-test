...
return static function (Application $app, MiddlewareFactory $factory, ContainerInterface $container): void {
    ...
    $app->route('/client/assign-project/{projectId}/{clientId}', [\Mia\Auth\Handler\AuthHandler::class, App\Handler\Client\AssignHandler::class], ['GET', 'OPTIONS', 'HEAD'], 'client.assign');
